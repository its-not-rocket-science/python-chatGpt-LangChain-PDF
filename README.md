# python-chatGpt-LangChain-PDF
## Python exercise using ChatGPT and LangChain: using uploaded PDFs as a knowledgebase.
From Stephen Grider's Udemy course at https://www.udemy.com/course/chatgpt-and-langchain-the-complete-developers-masterclass/
Updated LangChain and OpenAI libraries to latest versions, with code modified as necessary.
...
cd server\local-document-uploads
py .\app.py
